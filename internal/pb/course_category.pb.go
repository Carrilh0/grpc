...
func (x *CategoryReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryReponse) ProtoMessage() {}

func (x *CategoryReponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryReponse.ProtoReflect.Descriptor instead.
func (*CategoryReponse) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{2}
}

func (x *CategoryReponse) GetCategory() *Category {
	if x != nil {
		return x.Category
	}
	return nil
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0x3b, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x55, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x42, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x74, 0x65,
	...
	0x13, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x70,
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*CategoryReponse)(nil),       // 2: pb.CategoryReponse
}
var file_proto_course_category_proto_depIdxs = []int32{
	0, // 0: pb.CategoryReponse.category:type_name -> pb.Category
	1, // 1: pb.CategoryService.CreateCategory:input_type -> pb.CreateCategoryRequest
	2, // 2: pb.CategoryService.CreateCategory:output_type -> pb.CategoryReponse
